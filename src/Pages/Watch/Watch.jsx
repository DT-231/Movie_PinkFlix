...
function Watch() {
    ...
    useEffect(() => {
        ...
        console.log("Episode param:", episode);
        console.log("Server param:", server);
    ...
    return (
        <div ref={containerRef} className="bg-secondary min-h-screen flex flex-col gap-10 py-30 pb-[10px]">
